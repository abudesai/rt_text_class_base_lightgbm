...
def tune_hyperparameters(data, data_schema, num_trials, hyper_param_path, hpt_results_path):  
    ...
    def objective(**hyperparameters):   
        ...
        # train model
        model = model_trainer.train_model(train_X, train_y, valid_X, valid_y, hyperparameters) 
        ...
        return -opt_metric   # negative because gp_minimize minimizes, but our metric is accuracy, which we want to maximize
